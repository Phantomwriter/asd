...
function $(x) {
		var signupPage = document.getElementById(form);
		return signupPage;
		}
...
//links for the items
	function makeItemLinks(key, linksLi){
		var editLink=document.createElement('a');
			editLink.href ="#editContacts";
			editLink.key = key;
		var editText ="EditContacts";
		...
		var deleteLink=document.createElement('a');
			deleteLink.href="#showMembers";
			deleteLink.key =key;
		var deleteText ="showMembers";
...
//Local variables and function calls
		var contactGroups =["--Groups--", "Business", "Entrepreneur", "Artist", "Musician", "Techy"],
			deviceValue,				
			selectValue = "No",
			errMsg = go('errors');
